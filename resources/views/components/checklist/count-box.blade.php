...
<div class="grid grid-cols-4 divide-x text-xs">
    <span class="truncate bg-emerald-100 dark:bg-emerald-800 text-center" title="{{ $checklist->complete_tasks_count }} Completed Tasks">
        {{ $checklist->complete_tasks_count }}
    </span>
    <span class="truncate bg-zinc-100 dark:bg-zinc-700 text-center" title="{{ $checklist->incomplete_tasks_count }} Incomplete Tasks">
